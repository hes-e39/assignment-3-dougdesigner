...
interface TimersListHistoryProps {
    timers: TimerConfig[];
...
const TimersListHistory: React.FC<TimersListHistoryProps> = ({
    timers,
                        ...
                        <li key={timer.id} className="relative flex items-center space-x-4 py-4">
                            <div className="min-w-0 flex-auto">
                                <div className="flex items-center gap-x-3">
                                    ...
                                    {/* { timer.description && ( 
                                        <h3 className="min-w-0 text-sm/6 font-semibold text-white">{timerTypeMap[timer.description]}</h3>
                                    )} */}
                                </div>
...
export default TimersListHistory;
